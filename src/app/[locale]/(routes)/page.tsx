...
import { Card, CardContent, CardHeader, CardTitle } from "@cc/components/ui/card";

import {
  getTasksCount,
  getUsersTasksCount,
} from "@cc/actions/dashboard/get-tasks-count";
import { getModules } from "@cc/actions/get-modules";
import { getEmployees } from "@cc/actions/get-empoloyees";
import { getLeadsCount } from "@cc/actions/dashboard/get-leads-count";
import { getBoardsCount } from "@cc/actions/dashboard/get-boards-count";
import { getStorageSize } from "@cc/actions/documents/get-storage-size";
import { getContactCount } from "@cc/actions/dashboard/get-contacts-count";
import { getAccountsCount } from "@cc/actions/dashboard/get-accounts-count";
import { getContractsCount } from "@cc/actions/dashboard/get-contracts-count";
import { getInvoicesCount } from "@cc/actions/dashboard/get-invoices-count";
import { getDocumentsCount } from "@cc/actions/dashboard/get-documents-count";
import { getActiveUsersCount } from "@cc/actions/dashboard/get-active-users-count";
import { getOpportunitiesCount } from "@cc/actions/dashboard/get-opportunities-count";
import { getExpectedRevenue } from "@cc/actions/crm/opportunity/get-expected-revenue";
