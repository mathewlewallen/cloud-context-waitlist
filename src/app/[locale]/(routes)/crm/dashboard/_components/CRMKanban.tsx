...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@cc/components/ui/dropdown-menu";
import { useToast } from "@cc/components/ui/use-toast";
import { Avatar, AvatarImage } from "@cc/components/ui/avatar";
import LoadingModal from "@cc/components/modals/loading-modal";
import { Dialog, DialogContent, DialogTrigger } from "@cc/components/ui/dialog";
import { Card, CardContent, CardFooter, CardTitle } from "@cc/components/ui/card";

import { NewOpportunityForm } from "../../opportunities/components/NewOpportunityForm";
import { setInactiveOpportunity } from "@cc/actions/crm/opportunity/dashboard/set-inactive";
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
} from "@cc/components/ui/hover-card";
