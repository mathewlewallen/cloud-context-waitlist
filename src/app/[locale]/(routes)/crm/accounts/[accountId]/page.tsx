...
import { getAccount } from "@cc/actions/crm/get-account";
import { getAllCrmData } from "@cc/actions/crm/get-crm-data";
import { getOpportunitiesFullByAccountId } from "@cc/actions/crm/get-opportunities-with-includes-by-accountId";
import { getContactsByAccountId } from "@cc/actions/crm/get-contacts-by-accountId";
import { getLeadsByAccountId } from "@cc/actions/crm/get-leads-by-accountId";
import { getDocumentsByAccountId } from "@cc/actions/documents/get-documents-by-accountId";
import { getContractsByAccountId } from "@cc/actions/crm/get-contracts";
import { getAccountsTasks } from "@cc/actions/crm/account/get-tasks";
